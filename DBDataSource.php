...
require_once( __ADO_DATASOURCE_PHP_DIR__ . "/DBQuery.php");
...
/**
 * Base abstact  class for SQL data source implementation .
 * have support for executing statements.
 *
 */
class DBDataSource extends IDataSource
{
	var $lastError = NULL;
	var $timefunc = "time";
	 ...
	 */
	function queryStatement( $stm, &$resultcontainer )
	{
	...
	{
		Diagnostics::error("Abstract method must be implemented: ".  __METHOD__);
	}
