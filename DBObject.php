 ...
 */
class TM_DBObject extends Clonable
{
	/**
	...
	function table_name()
	{
		Diagnostics::error("Not implemented.");
	}
	...
	@return DBColumnDefinition as information about primary key
	 */
	...
	/** return unique ID  as text combined from several primary keys
	 @return created unique ID as \b string 
	 */
	function get_uid ()
	{
	...
	/** return ASSOC array with new values
	 @return associative \b array  of changed columns
	 */
...
if( !class_exists( 'DBObject')) {
	class DBOBject extends TM_DBObject {}
}

define("CLASS_DBObject", get_class(new TM_DBObject()));
